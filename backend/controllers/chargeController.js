...
const createCharge = async (req, res) => {
    try {
        const { name, type, basePrice, department, description, code, resultTemplate, standardFee, retainershipFee, familyRetainershipFee, joudAlkhairFee, nhiaFee, kschmaFee } = req.body;
...
const updateCharge = async (req, res) => {
    try {
        ...
        if (charge) {
            ...
            charge.joudAlkhairFee = req.body.joudAlkhairFee !== undefined ? req.body.joudAlkhairFee : charge.joudAlkhairFee;
